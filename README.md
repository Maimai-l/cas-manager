...
lot of it turns into paperwork — logging into ManageBac and filling reflection
boxes so a coordinator can tick them off. This app takes that part off your
...
- **AI prompts.** Turns rough notes into a reflection. It builds a prompt with
